...
class TreeParser:
    ...
    def __init__(self, text: str):
        ...
        self.instructions: List[Tuple[str, str]] = []  # [(type, path), ...]  type: "dir" | "file"
    ...
    def _is_tree_format(self, lines) -> bool:
    ...
    def _is_markdown_codeblock(self, lines) -> bool:
    ...
    def _detect_indent_width(self, lines) -> int:
